...
Defines how `apps/backend` connects to Postgres via Prisma: the driver-adapter-based connection, its lifecycle tied to NestJS's module system, and a health-check endpoint that proves database connectivity end-to-end.
