...
## Purpose
Defines the local development infrastructure for the project: how developers stand up Postgres, Redis, and Mailpit locally via Docker Compose, how those services are configured through environment variables, and how outgoing email is sandboxed during development.
