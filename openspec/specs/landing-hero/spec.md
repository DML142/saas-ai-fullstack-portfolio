...
Defines the landing page hero's visual system: base design tokens (palette, typography), the word-cycling headline, the blend-mode star field, and the scoped chromatic aberration effect — the foundation the rest of the COS Code site builds on.
